from neo4j_utils import (
    ...
    eliminar_nodo,
    listar_relaciones,
    gestionar_relacion_y_actualizar_amistad
)
...
class UsuarioRepository:
    ...
    def seguir_usuario(id, id_seguir):
        """
        Crea una relación de seguimiento entre dos usuarios y actualiza la propiedad `esAmigo` si ambos se siguen mutuamente.
        Args:
        ...
        """
        return gestionar_relacion_y_actualizar_amistad(
            "Persona", "idPersona", id, "Persona", "idPersona", id_seguir, "SIGUE"
        )
